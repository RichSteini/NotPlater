NotPlaterLocals = {
	...
	["Note: All settings here only work out of combat, because the frame cannot be changed in combat."] = "Note: All settings here only work out of combat, because the frame cannot be changed in combat.",
